...
import poetrybg from "../assets/poetry-bg.png"
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="flex justify-center text-center h-[50vh] w-auto">
        ...
        <span className="text-8xl font-pacifico bg-gradient-to-r from-red-400 to-peach text-transparent bg-clip-text p-6">Loving The World</span><br /><br/>
        <span className="text-5xl bg-gradient-to-r from-gray-800 to-gray-500 text-transparent bg-clip-text font-bold">So The World Can Love You Back </span>
        </h2>
      ...
      <div className="justify-center items-center flex">
        <img src={scrollDown} className="animate-pulse"></img>
        </div>


      {/* New Section */}
      <section className="flex justify-center items-start py-20 px-12 mx-6">
      ...
      <footer className="bg-white py-8 text-center text-gray-600">
        <p>© 2024 Project Love. All rights reserved.</p>
      </footer>
    </div>
  );
};
